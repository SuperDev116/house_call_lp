...
<title>夜間緊急往診 ナイトドクター｜コロナ抗体検査</title>
      ...
      <div class="innerWrap">
        ...
        <form class="contact-form" name="contactform" role="form" method="post" action="">
          ...
          <table class="form_table">
            <tr>
              <td class="input_ttl">患者様のお名前</td>
              <td class="input_source"><?php echo h($name); ?></td>
            </tr>
            <tr>
              <td class="input_ttl">患者様の性別</td>
              <td class="input_source"><?php echo h($gender); ?></td>
            </tr>
            <tr>
              <td class="input_ttl">患者様の生年月日</td>
              <td class="input_source"><?php echo h($birthgengou); ?> <?php echo h($birthyear); ?> 年 <?php echo h($birthmonth); ?> 月 <?php echo h($birthday); ?> 日</td>
            </tr>
            <tr>
              <td class="input_ttl">患者様のご住所</td>
              <td class="input_source"><?php echo h($address); ?></td>
            </tr>
            <tr>
              <td class="input_ttl">お電話番号</td>
              <td class="input_source"><?php echo h($tel); ?></td>
            </tr>
            <tr>
              <td class="input_ttl">メールアドレス</td>
              <td class="input_source"><?php echo h($email); ?></td>
            </tr>
            <tr>
              <td class="input_ttl">保険証の有無</td>
              <td class="input_source"><?php echo h($card); ?>　<?php echo h($cardtype); ?></td>
            </tr>
            <tr>
              <td class="input_ttl">ご病状、お問合せ内容</td>
              <td class="input_source"><?php echo h($message); ?></td>
            </tr>
          </table>
          ...
          <div class="flex_wrap frm_btn">
            ...
            <div><button type="button" onclick="contactform.action='index.php#contact';contactform.submit();" class="btn_back">戻る</button></div>
          </div>
