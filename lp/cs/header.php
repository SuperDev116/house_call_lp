...
<html lang="zh-cmn-Hans" prefix="og: http://ogp.me/ns#">
  ...
  <link href="assets/css/style.css?<?php echo date('YmdHi'); ?>" rel="stylesheet">
...
<body ontouchstart="" class="page-<?php echo $page_id; ?>">
...
<header id="header">
  <ul class="language-switch-list">
    ...
    <li><a href="https://piq.jp/lp/cs" class="current">中文</a></li>
  </ul>
  <div id="mv">
    <div class="container" data-animate="fadeIn">
      <div class="mv-content">
        <p class="catch">2020年 超过34,000例 夜间出诊的记录</p>
        <h1><i class="fas fa-moon"></i>夜间节假日紧急出诊<span> <br class="sp">Night Doctor</span></h1>
        <h2>
          夜间及节假日提供医生上门急救出诊服务
        </h2>
