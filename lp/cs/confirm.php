...
$page_id = 'contact';
$page_title = '确认发送的内容 | Night Doctor';
$page_description = '确认发送的内容';
    ...
    <form class="contact-form" name="contactform" role="form" method="post" action="">
      ...
      <div class="btn-area">
        <div class="row">
          ...
          <div class="col-sm-4 col-6">
            <button type="button" onclick="contactform.action='index.php#contact';contactform.submit();" class="btn-back">返回</button>
          </div>
        </div>
      </div>
    </form>
